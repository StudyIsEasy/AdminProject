...
public abstract class CrudController<Request,Response,Service> implements CrudInterface<Request,Response> {

    @Autowired
    protected BaseService<Request, Response, Service> baseService;
